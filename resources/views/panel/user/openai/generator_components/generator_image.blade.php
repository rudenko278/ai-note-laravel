        ...
        <div class="col-12">
            <div class="card bg-[#F3E2FD] !shadow-sm dark:bg-[#14171C] dark:shadow-black">
                <div class="card-body md:p-10">
                    <div class="row">
                        <label for="description" class="h2 mb-3">{{__('Explain your idea')}}. | <a onclick="return fillAnExample();" class="text-success" href="">Generate example prompt</a> </label>
                            ...
                            <div class="relative mb-3">
                                ...
                                @foreach(json_decode($openai->questions) as $question)
                                    @if($question->type == 'textarea')
                                        <input class="image-input-for-fillanexample form-control bg-[#fff] rounded-full h-[53px] text-[#000] !shadow-sm placeholder:text-black focus:bg-white focus:border-white dark:!border-none dark:!bg-[--lqd-header-search-bg] dark:focus:!bg-[--lqd-header-search-bg] dark:placeholder:text-[#a5a9b1]" type="text" id="{{$question->name}}" name="{{$question->name}}" placeholder="{{$placeholders[array_rand($placeholders)]}}">
                                    @endif
                                @endforeach
