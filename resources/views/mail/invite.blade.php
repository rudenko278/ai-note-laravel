...
<div class="wrap">
    ...
    <div class="content">
        ...
        <div class="content-head">
            <img src="{{env('APP_URL')}}/images/mail/invite-head.jpg" alt="Invitation" width="1144" height="564">
        </div>
        ...
        <div class="content-contents">
            ...
            <div class="content-indent">
                ...
                <div style="padding: 0 19px">
                    ...
                    <p>Hey,</p>
                    <p>We’re excited to invite you to join {{env('APP_NAME')}}. It is designed to help businesses and individuals leverage the power of artificial intelligence to generate any kind of content easily.</p>
                    <p>You can use {{env('APP_NAME')}} for: </p>
                    <p>
                    <ul>
                        <li>Copywriting</li>
                        <li>Images</li>
                ...
                <a href="{{env('APP_URL')}}/register?aff={{$user->affiliate_code}}" class="btn btn-lg btn-block btn-round">
                    Discover {{env('APP_NAME')}}
                </a>

                <p class="need-help-p">Need help? <a href="{{env('APP_URL')}}">Contact us.</a></p>
