...
<div class="wrap">
    ...
    <div class="content">
        ...
        <div class="content-head">
            <img src="{{env('APP_URL')}}/images/mail/confirmation-head.jpg" alt="Confirmation" width="1144" height="564">
        </div>
        ...
        <div class="content-contents">
            ...
            <div class="content-indent">
                ...
                <div style="padding: 0 19px">
                    ...
                    <p>We are pleased to inform you that your {{env('APP_NAME')}} account has been successfully created. </p>
                ...
                <a href="{{env('APP_URL')}}/confirm/email/{{$user->email_confirmation_code}}" class="btn btn-lg btn-block btn-round">
                    Confirm My Account
                </a>
