...
document.addEventListener( "DOMContentLoaded", function () {
	...
	$( 'body' ).on( 'click', '.workbook_download', event => {
		...
		const html = `
<html ${ this.doctype === 'docx' ? 'xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word" xmlns="http://www.w3.org/TR/REC-html40"' : '' }>
<head>
	<meta charset="utf-8" />
	<title>${ docName }</title>
</head>
<body>
	${ content }
		...
		const url = `${ docType === 'docx' ? 'data:application/vnd.ms-word;charset=utf-8' : 'data:text/plain;charset=utf-8' },${ encodeURIComponent( html ) }`;
